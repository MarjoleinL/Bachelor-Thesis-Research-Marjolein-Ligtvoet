...
#We want mean and standard deviation to be plotted 

# Loop for creating cohort
for patient_index in range(num_patients):
    ...
    for j, mode in enumerate(modes):
        ...
        #Calculations for each low, mid and high DPI 
...
plt.title('Influence of Daily Protein Intake (DPI) on Urea Dialysate Concentrations in Females')
...
file_path = 'trail1_female_patients.json'
...
df_from_json = pd.read_json('trail1_female_patients.json')

# Save DataFrame to a CSV file
df_from_json.to_csv('trial1_female_patients.csv', index=False)

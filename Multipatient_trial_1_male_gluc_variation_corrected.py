...
fig.suptitle('Influence of CD Glucose on Solute Clearance in relation to Daily Protein Intake (DPI) in Males', fontsize=14)
...
fig.supxlabel('Mean DPI (g/day), CD Glucose (mmol/L)')
fig.supylabel('Total solute removal (mmol)')
fig.suptitle('Influence of CD Glucose on Urea Clearance in relation to Daily Protein Intake (DPI) in Males', fontsize=14)
...
file_path = 'trail1_male_patients_gluc.json'
...
df_from_json = pd.read_json('trail1_male_patients_gluc.json')

# Save DataFrame to a CSV file
df_from_json.to_csv('trial1_male_patients_gluc.csv', index=False)
